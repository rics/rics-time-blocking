...
const STATIC_TEXT = [
  ...
  ['Apoie o Rics Time-blocking no Ko-fi (abre em uma nova aba)', 'Support Rics Time-blocking on Ko-fi (opens in a new tab)'],
  ['Apoie o Rics Time-blocking no Ko-fi', 'Support Rics Time-blocking on Ko-fi'],
  ['Resultado', 'Result'],
  ...
  ['Curtiu? Fortalece o projeto.', 'Enjoying it? Help the project keep going.'],
  ['Se o Rics já salvou seu dia de algum jeito, considere bancar um cafezinho pra manter o projeto vivo — sem pressão. ☕', 'If Rics has made your day easier in any way, consider buying me a coffee to keep the project alive — no pressure. ☕'],
